...
var PostWhere = struct {
	...
	Created:  whereHelperstring{field: "`posts`.`created`"},
...
var (
	postAllColumns            = []string{"id", "title", "content", "created", "author_id"}
	postColumnsWithoutDefault = []string{"id", "title", "content", "created", "author_id"}
