...
type User struct {
	...
	Hoby string `boil:"hoby" json:"hoby" toml:"hoby" yaml:"hoby"`
...
var UserWhere = struct {
	...
	Hoby whereHelperstring
}{
	ID:   whereHelperstring{field: "`users`.`id`"},
	Name: whereHelperstring{field: "`users`.`name`"},
	Hoby: whereHelperstring{field: "`users`.`hoby`"},
}
...
var (
	userAllColumns            = []string{"id", "name", "hoby"}
	userColumnsWithoutDefault = []string{"id", "name", "hoby"}
